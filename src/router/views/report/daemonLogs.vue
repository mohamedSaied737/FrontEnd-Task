...
export default {
  ...
  methods: {
    ...mapActions("daemon", ["fetchRequestLogs"]),
    onToggleVisible() {
      this.$bvModal.show("");
    },
    onRowClicked() {
  ...
  <Layout>
    ...
    <div class="export-list-wrapper grid-data">
      ...
      >
        ...
        <!-- Kiosk -->
        <b-table-column field="kiosk" label="Kiosk" searchable sortable>
          <template slot="searchable" slot-scope="props">
            <b-input
              v-model="props.filters[props.column.field]"
              placeholder="Search..."
        ...
        <!-- Reason Of Failure -->
        <b-table-column field="reasonOfFailure" label="Reason Of Failure" searchable sortable>
          <template slot="searchable" slot-scope="props">
            <b-input
              v-model="props.filters[props.column.field]"
              placeholder="Search..."
        ...
        <b-table-column label="Action">
          <template v-slot="props">
            <a
              ...
              v-if="props.row.download.length && props.row.type !== 'Update App'"
