...
export default {
  ...
  computed: {
    ...
    packageType() {
      return this.currentEntity.package;
    },
  },
  methods: {
      ...
      <template v-for="item in menuItems">
        ...
        <li
          :class="
            packageType == 'Standalone' &&
              $t(item.label) != 'Sites & Kiosks' &&
              $t(item.label) != 'Company Details' &&
              $t(item.label) != 'Back To Passport' &&
              'disabled-list-item'
          "
        ...
        >
          ...
          >
            <i
              @click="
                $t(item.label) == 'Back To Passport' && onBackToPassport()
              "
              :class="`bx ${item.icon}`"
              v-if="item.icon"
            ></i>
